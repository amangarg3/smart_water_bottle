...
public class DatabaseClass {
    ...
    private static final String DBNAME = "B_Record.db";
    ...
    //insert data in Day table(Records)
    ...
    //get count of data in Day table(Records)
    ...
    // To check Whether day's database is empty or not.
    ...
    // To check Whether week's database is empty or not.
