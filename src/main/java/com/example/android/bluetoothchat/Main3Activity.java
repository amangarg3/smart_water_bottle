...
public class Main3Activity extends ActionBarActivity {
    ...
    //this adapter is for barchart of week view
    ...
    //it is the fragment for the adapter class of bar chart
    public static class DemoObjectFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater,
            ...
            //Here only one entry is inserted for every day
            //Code first checks whether any entry is present in the database or not and if that entry is present then it removes that entry and value of that entry is added to the new upcoming entry
           ...
           // int b=1;
            ...
            // calculating the day of the week ie whether it is monday or tues ....etc
            day = day - y;
            if(day<0)
                day = day+7;
...
/*
This is for changing the font style of the text..
