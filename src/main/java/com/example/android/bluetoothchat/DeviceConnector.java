...
public class DeviceConnector {
    ...
    public synchronized void connected(BluetoothSocket socket) {
        ...
        Message msg = mHandler.obtainMessage(Main2Activity.MESSAGE_DEVICE_NAME, deviceName);
    ...
    private class ConnectedThread extends Thread {
            ...
            while (true) {
                try {
                    ...
                    if (readed.contains(answerEndingFlag)) {
                        mHandler.obtainMessage(Main2Activity.MESSAGE_READ, bytes, -1, readMessage.toString()).sendToTarget();
        ...
        public void writeData(byte[] chunk) {
            ...
            try {
                ...
                mHandler.obtainMessage(Main2Activity.MESSAGE_WRITE, -1, -1, chunk).sendToTarget();
            } catch (IOException e) {
